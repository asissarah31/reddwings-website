...
<nav id="sidebar" class='mx-lt-5 bg-dark'>
    <div class="sidebar-list">
        ...
        <a href="index.php?page=orders" class="nav-item nav-orders">
            <span class='icon-field'><i class="fas fa-shopping-cart"></i></span> Orders
        </a>
        <a href="index.php?page=menu" class="nav-item nav-menu">
            <span class='icon-field'><i class="fas fa-list"></i></span> Menu
        </a>
        <a href="index.php?page=categories" class="nav-item nav-categories">
            <span class='icon-field'><i class="fas fa-tags"></i></span> Category List
        </a>
        
        <!-- New Gallery Section -->
        <a href="index.php?page=gallery" class="nav-item nav-gallery">
            <span class='icon-field'><i class="fa fa-image"></i></span> Gallery
        </a>

        <!-- New Reservation Section -->
        <a href="index.php?page=reservation_list" class="nav-item nav-reservation_list">
            <span class='icon-field'><i class="fa fa-calendar-alt"></i></span> Reservations
        </a>
