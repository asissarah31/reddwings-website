...
// Fetch system settings from the database and store in session
...
<style>
    header.masthead {
        ...
        background-color: red; /* Change to skyblue */
        position: relative;
    ...
    <nav class="navbar navbar-expand-lg navbar-light fixed-top py-3" id="mainNav">
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarResponsive">
				...
				<li class="nav-item">
					<a class="nav-link js-scroll-trigger" href="index.php?page=view_orders">View Orders</a>
				</li>
                    ...
                    <!-- Book a Table Link -->
                    <li class="nav-item">
                        <a class="nav-link js-scroll-trigger" href="index.php?page=reserve_table">Book a Table</a>
                    </li>
